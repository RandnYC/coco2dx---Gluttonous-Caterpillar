...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("van van Yuchen de Snake", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
	...
	paths.push_back("GameScene");
	paths.push_back("Snake");
